...
class _CatatanState extends State<Catatan> {
  ...
  void SimpanBiaya_AC(BuildContext context) {
    setState(() {
      ...
      if (isiBiayaAC.text.isNotEmpty && hargaIsiBiayaAC.text.isNotEmpty) {
        ...
        biayaKebutuhans.add(CatatanBiaya(isiBiayaAC.text,
            double.parse(hargaIsiBiayaAC.text.replaceAll(".", ""))));
        isiBiayaAC.clear();
  ...
  void initState() {
    ...
    List_Kebutuhan = List<List<dynamic>>.from(
        widget.List_Kebutuhan.map((item) => [item, false]));
  }
                      ...
                      style: ElevatedButton.styleFrom(
                          ...
                          shape: RoundedRectangleBorder(
                            ...
                            side: const BorderSide(
                                color: Warna.lightgreen, width: 5),
                          )),
                      child: Container(
                        width: 200,
                        child: Center(
